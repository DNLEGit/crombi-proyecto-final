...
export default function Card({ user }: { user: User }) {
  return (
    <div className="drop-shadow-xl w-128 h-160 overflow-hidden rounded-2xl 
    bg-gradient-to-br from-[#3d3c3dcc] to-[#2c2b2bcc] backdrop-blur-md 
    flex flex-col justify-between p-4 transition-transform duration-300 hover:scale-105">
      ...
      <div className="text-white text-center mt-4">
        ...
        <div className="text-lg font-light truncate">{user.email}</div>
      </div>
      ...
      <div className="flex justify-end mt-6">
        ...
        >
          <svg
            ...
            height="30"
            viewBox="0 0 32 32"
            className="transition-colors duration-200 group-hover:fill-blue-400 fill-gray-300"
          >
